        ...
        <section className="w-full flex flex-col items-center justify-center space-y-1 lg:space-y-2 py-10 lg:py-20">
          <div className="px-4 md:px-6 space-y-7 xl:space-y-10">
            ...
            <p className="mx-auto max-w-[700px] text-gray-500 md:text-xl dark:text-gray-400 text-center leading-relaxed">
              I once tried yoga and achieved a state of unconsciousness, which I hear is the point. I'm an enthusiast of
              fine dining at any place with a drive-thru. My life goal is to find socks that match and I believe in
              living every day like it's Tuesday — the potential is limitless.
            </p>
